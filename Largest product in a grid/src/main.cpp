...
int main() {
	...
	for(int row = 0; row <= 20; row++) {
		for(int column = 0; column <= 20-4; column++) {
			...
			std::cout << grid[row][column] << "*" << grid[row][column+1] << "*" << grid[row][column+2] << "*" << grid[row][column+3] << " = " << product << std::endl;
	...
	for(int column = 0; column < 20; column++) {
		for(int row = 0; row <= 20-3; row++) {
			...
			std::cout << grid[row][column] << "*" << grid[row+1][column] << "*" << grid[row+2][column] << "*" << grid[row+3][column] << " = " << product << std::endl;
			if(product > largest_product_so_far) {
				largest_product_so_far = product;
			}
		}
	...
	for(int row = 0; row <= 20-4; row++) {
		for(int column = 0; column <= 20-4; column++) {
			...
			std::cout << grid[row][column] << "*" << grid[row+1][column+1] << "*" << grid[row+2][column+2] << "*" << grid[row+3][column+3] << " = " << product << std::endl;
			if(product > largest_product_so_far) {
				largest_product_so_far = product;
			}
		}
	...
	std::cout << largest_product_so_far << std::endl;
